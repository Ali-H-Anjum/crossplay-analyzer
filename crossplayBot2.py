...
def simulated_game_test():
    ...
    all_initial_moves = get_all_initial_moves(wd, t)

    print(t)

    print(all_initial_moves)

    print(len(all_initial_moves))

    best_initial_moves = get_best_initial_moves(wd, t)

    print(best_initial_moves)

    print(len(best_initial_moves))



    move_for_most_points, most_points = get_most_points_in_dictionary(all_initial_moves)
    
    w, x, y, d = move_for_most_points

    print(f"{w} {x} {y} {d} {most_points}")
    #add_word_to_board(b, w, x, y, d)
